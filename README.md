...
| `/api/admin/users/<id>/role` | PUT | 更新角色 |

### 题库管理

| 接口 | 方法 | 描述 |
| :--- | :--- | :--- |
| `/api/bank/structure` | GET | 获取题库结构 |
| `/api/bank/questions` | GET | 获取题目列表 |
| `/api/bank/save-question` | POST | 保存题目 |
| `/api/bank/delete-question` | POST | 删除题目 |
| `/api/bank/add-subject` | POST | 新增科目 |
| `/api/bank/delete-subject` | POST | 删除科目 |
| `/api/bank/rename-subject` | POST | 重命名科目 |
| `/api/bank/add-chapter` | POST | 新增章节 |
| `/api/bank/delete-chapter` | POST | 删除章节 |
| `/api/bank/rename-chapter` | POST | 重命名章节 |
| `/api/bank/add-topic` | POST | 新增考点 |
| `/api/bank/delete-topic` | POST | 删除考点 |
| `/api/bank/rename-topic` | POST | 重命名考点 |
...
| `/api/paper/generate` | POST | 生成单套试卷 |
| `/api/paper/generate-multiple` | POST | 生成多套试卷 |
| `/api/paper/download-word/<folder>` | GET | 下载 Word 试卷 |
